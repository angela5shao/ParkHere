...
//    public static final String LAST_USER_ROLE = "Provider";
    ...
    public static final String LICENSE_PLATE_TO_BE_TYPED = "747234";
...
//    }
    ...
    public void editPhoneNumberShort() {
        ...
        onView(withId(R.id.editLogo)).perform(click());
        onView(withId(R.id.pwText)).perform(typeText("1234567890") , closeSoftKeyboard());
        onView(withId(R.id.phoneText)).perform(clearText()).perform(typeText(PHONE_TO_BE_TYPED_SHORT), closeSoftKeyboard());
    ...
    public void editPasswordShort() {
        ...
        onView(withId(R.id.usernameText)).check(matches(withText(EMAIL_TO_BE_TYPED)));
        onView(withId(R.id.editLogo)).perform(click());
        onView(withId(R.id.pwText)).perform(typeText("123456789"), closeSoftKeyboard());
        onView(withId(R.id.phoneText)).perform(clearText()).perform(typeText("7329123214"), closeSoftKeyboard());
        onView(withId(R.id.btn_save)).perform(ViewActions.scrollTo()).perform(click());
        // TODO: check licence ID & licence plate
        onView(withId(R.id.profilePic)).perform(click());
        onView(withId(R.id.usernameText)).check(matches(withText(EMAIL_TO_BE_TYPED)));
