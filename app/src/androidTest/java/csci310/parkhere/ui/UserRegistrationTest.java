...
public class UserRegistrationTest {
    ...
    public static final String NAME_TO_BE_TYPED = "User3 USC";
    public static final String EMAIL_TO_BE_TYPED = "user3@usc.edu";
    public static final String NAME2_TO_BE_TYPED = "User2 USC";
    public static final String EMAIL2_TO_BE_TYPED = "user2@usc.edu";
