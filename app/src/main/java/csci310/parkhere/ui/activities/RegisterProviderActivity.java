...
public class RegisterProviderActivity extends Activity {
    ...
    private void register(View v) {
        ...
        VeifyRegTask = new UserVerifyRegisterTask(email, password, phonenum, licenseID,"#######", "provider", name);
    ...
    private class UserVerifyRegisterTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String code) {
            ...
            if(code != null) {
                ...
                final Dialog reviewDialog = new Dialog(RegisterProviderActivity.this);
